...
#[doc = "Protocol engine clock source\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Clksrc {
    #[doc = "0: Protocol engine uses a separate chip-specific clock."]
    External = 0,
    #[doc = "1: Protocol engine uses the main peripheral clock."]
    Peripheral = 1,
}
...
#[doc = "Field `CLKSRC` reader - Protocol engine clock source"]
...
impl ClksrcR {
    ...
    pub const fn variant(&self) -> Clksrc {
        match self.bits {
            false => Clksrc::External,
            true => Clksrc::Peripheral,
        }
    }
    #[doc = "Protocol engine uses a separate chip-specific clock."]
    #[inline(always)]
    pub fn is_external(&self) -> bool {
        *self == Clksrc::External
    }
    #[doc = "Protocol engine uses the main peripheral clock."]
    #[inline(always)]
    pub fn is_peripheral(&self) -> bool {
        *self == Clksrc::Peripheral
    }
}
#[doc = "Field `CLKSRC` writer - Protocol engine clock source"]
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    pub fn external(self) -> &'a mut crate::W<REG> {
        self.variant(Clksrc::External)
    }
    #[doc = "Protocol engine uses the main peripheral clock."]
    #[inline(always)]
    pub fn peripheral(self) -> &'a mut crate::W<REG> {
        self.variant(Clksrc::Peripheral)
    }
}
...
impl R {
    ...
    #[doc = "Bit 13 - Protocol engine clock source"]
    #[inline(always)]
